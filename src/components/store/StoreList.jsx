      ...
      <S.StoreTable>
        <S.TableHeader>
          <tr style={{ display: 'flex' }}>
            ...
            <S.TableHeaderCell style={{ width: '200px' }}>이름</S.TableHeaderCell>
            <S.TableHeaderCell style={{ width: '572px' }}>취급 품목</S.TableHeaderCell>
          ...
          {stores.map((store) => (
            <S.TableRow key={store.id} onClick={() => handleStoreClick(store.id)}>
              ...
              <S.TitleCell>
                ...
                <S.Line style={{ marginRight: '8px' }} ></S.Line>
              </S.TitleCell>
              ...
              <S.KeywordCell>
                {Array.isArray(store.keyword) && store.keyword.length > 0
                  ...
                  : <S.Line style={{ marginLeft: '-7px' }}></S.Line>}
              </S.KeywordCell>
              <S.ContactCell>
